...
\author{{於俊、Changwen Chen、Fan Yu、王聪、骆阳、张然、杜文卓、徐鑫、王柯、汪志立、刘中一、曹旭宏、穆冠霖、刘冠君、邹月峰、徐霖、陈昕宇、陈峰鑫、李轩、Gongpeng Zhao、王灿、Feng Zhao、Ye Yu、Fang Gao、Jiaen Liang、Wei Huang、Shengping Liu、Qingsong Liu、Jianqing Sun}}
