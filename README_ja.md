...
> **バージョン注記**：中国語版は現在の 2026 Springer 出版主線で、14 部、48 章、15 件のプロジェクトケーススタディ、8 つの付録（A–H）に固定されています。英語版と日本語版は部分翻訳および対外紹介用ビューとして更新中で、ドキュメントサイトには翻訳状況ページを用意しています。
...
```
📖 全14部、48章 + 15件のプロジェクトケーススタディ + 8つの付録（A–H）
│
├── 第1部：総論とインフラ（第1-3章）
...
├── 第12部：専門データセットとマルチモーダルデータエンジニアリング実践（第38-43章）
